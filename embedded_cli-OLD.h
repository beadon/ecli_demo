...
// Compiler handles the structs
// only if typedef is next to the definition
...
typedef struct EmbeddedCli {
     ...
     */
    // ORIG -- void (*writeChar)(EmbeddedCli *cli, char c);
    void *(EmbeddedCli *cli, char c);
     ...
     */
    // ORIG -- void (*onCommand)(EmbeddedCli *cli, CliCommand *command);
 ...
 */
typedef struct EmbeddedCliConfig {
    /**
